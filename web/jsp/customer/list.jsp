                        ...
                        <TABLE id=grid
                            ...
                            <c:forEach items="${customerList}" var="customer">
                                <TR
                                    ...
                                    <TD>
                                        <a href="${pageContext.request.contextPath }/customer_edit.action?cid=${customer.cid }">修改</a>
                                        &nbsp;&nbsp; <a
                                            href="${pageContext.request.contextPath }/customer_delete.action?cd=${customer.cid }">删除</a>

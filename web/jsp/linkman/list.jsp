										...
										<TBODY>
											...
											<c:forEach items="${linkManList }" var="linkman">
												<TR
													...
													<TD><a href="${pageContext.request.contextPath }/linkman_toEditPage.action?linkid=${linkman.linkid}">修改</a>
														<%--&nbsp;&nbsp; <a
														href="${pageContext.request.contextPath }/linkman_delete?linkid=${linkman.linkid}">删除</a></TD>--%>
												</TR>

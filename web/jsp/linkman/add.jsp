        ...
        <TR>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    ...
                    <TR>
                        <td>联系人名称：</td>
                        <td><INPUT class=textbox id=lkmName style="WIDTH: 180px"
                                   maxLength=50 name="lkmName"
                    ...
                    <TR>
                        <td>联系人办公电话 ：</td>
                        <td><INPUT class=textbox id=lkmPhone style="WIDTH: 180px"
                                   maxLength=50 name="lkmPhone"
                        ></td>
                        <td>联系人手机 ：</td>
                        <td><INPUT class=textbox id=lkmMobile style="WIDTH: 180px"
                                   maxLength=50 name="lkmMobile"
                        ></td>
                    </TR>
                    <TR>
                        <td>选择图片 ：</td>
